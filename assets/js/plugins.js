  ...
  (e.extend(n.prototype, {
    ...
    e.widget("ui.dialog", {
      ...
      _trackingInstances: function () {
        ...
        return (
          e || ((e = []), this.document.data("ui-dialog-instances", e)),
          e
        );
      },
      _minHeight: function () {
      ...
      function i(t, i) {
        ...
        for (s in i)
          ((a = i[s]),
            t[s] !== a &&
              (n[s] ||
                ((e.fx.step[s] || !isNaN(parseFloat(a))) && (o[s] = a))));
        return o;
      }
...
(function (global, factory) {
  ...
  var defaultLocaleMonths =
    "January_February_november_April_May_June_July_August_September_October_November_December".split(
      "_",
    );
  function localeMonths(m, format) {
    return isArray(this._months)
      ? this._months[m.month()]
      : this._months[MONTHS_IN_FORMAT.test(format) ? "format" : "standalone"][
          m.month()
        ];
  }
    ...
    return (
      ...
      (e.prototype.parse = function (e) {
        ...
        if (
          ...
          if (_ == null)
            throw (
              (o = 'No element with id="' + this.options.target + '" on page.'),
              new Error(o)
            );
          (_.appendChild(u),
    ...
    initFadeOut: function () {
      return (
        ...
        setTimeout(function () {
          (self.arrayPos++,
            self.replaceText(""),
            self.strings.length > self.arrayPos
              ? self.typewrite(self.strings[self.sequence[self.arrayPos]], 0)
              : (self.typewrite(self.strings[0], 0), (self.arrayPos = 0)));
        }, self.fadeOutDelay)
      );
    },
        ...
        if (
          ...
          if (YTPlayer.opt.autoPlay) {
            ...
            if (
              ...
              //jQuery.mbBrowser.os.minor_version < 11
...
jQuery.browser.versionCompare = function (a, e) {
  ...
  for (
    ...
    if (
      (c[b] && !d[b] && 0 < parseInt(c[b])) ||
      parseInt(c[b]) > parseInt(d[b])
    )
      return 1;
    if (
      (d[b] && !c[b] && 0 < parseInt(d[b])) ||
      parseInt(c[b]) < parseInt(d[b])
    )
      return -1;
  }
